...
import aboutCardImg from '@/assets/img/about_card.jpg';
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
          <h2 class="text-center">BİZ KİMİK?</h2>
          <RotatingCard>
            ...
            <RotatingCardFront 
              ...
              description="All the Bootstrap components that you need in a development have been re-designed with the new look."
            />
